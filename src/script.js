...
//Light 2
const pointLight2 = new THREE.PointLight(0xff003c, 2)
pointLight2.position.set(-1.3,1,0.1)
...
//Light 3
const pointLight3 = new THREE.PointLight(0x92c5, 2)
pointLight3.position.set(1.3,-1,0.1)
